...
// 压力控制
int buttonPin[buttonNumber] = {10, 11};                                   // 设置按键引脚（A-22  B-23）

bool buttonFlag[buttonNumber] = {LOW, LOW};                               // 按键状态
bool lastButtonFlag[buttonNumber] = {LOW, LOW};                           // 上一次按键
